...
if __name__ == "__main__":
    ...
    if CONFIG.get("account_group_id"):
        ...
        relevant_accounts = get_account_list(
            enterprise_id, CONFIG.get("account_group_id"), enterprise_access_token
        )
        ...
        relevant_accounts = create_account_identity_map(
            enterprise_access_token, CONFIG.get("account_list")
        )
    ...
    if filtered_trusted_profiles:
        ...
        if image_operation == "IMPORT":
            ...
            # Import the image
            result = deploy_image_to_child_accounts(
            ...
            # Delete the image
            result = delete_image_from_child_accounts(
                filtered_trusted_profiles,
                enterprise_access_token,
                log_operation_file_name,
            )
